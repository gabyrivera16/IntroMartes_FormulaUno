...
import plataforma.de.servicios.Validacion;

/**
 *
 * @author jvsan
 */
public class Validacion_contra {
static int mensaje = 0;
    public static void   Validacion_contra() {
        int cant=0;              
do{  
...
contra[20]= 10987; 
     ...
     if(codigo == veri[0]){
      ...
      else if(codigo == veri[20]){
         mensaje = Integer.parseInt(JOptionPane.showInputDialog("Ingrese su contraseña: "));
         if(mensaje == contra[20]){
             JOptionPane.showMessageDialog(null, "Su contraseña fue exitosa, Señor Gerente");
         }
         else if(mensaje != contra[20]){
             JOptionPane.showMessageDialog(null, "Su contraseña fue incorrecta");
             System.exit(0);
         }
     }
     else if(codigo != veri[0]||codigo != veri[1] ||codigo != veri[2] ||codigo != veri[3] ||codigo != veri[4] ||codigo != veri[5] ||codigo != veri[6] ||codigo != veri[7] ||codigo != veri[8] ||codigo != veri[9] ||codigo != veri[10] ||codigo != veri[12] ||codigo != veri[13] ||codigo != veri[14] ||codigo != veri[15]||codigo != veri[16]||codigo != veri[17]||codigo != veri[18]||codigo != veri[19]||codigo != veri[20]){
